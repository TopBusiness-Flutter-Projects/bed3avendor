...
import 'package:bed3avendor/data/model/body/seller_body.dart';
import 'package:bed3avendor/data/model/response/base/api_response.dart';
import 'package:bed3avendor/data/model/response/response_model.dart';
import 'package:bed3avendor/data/model/response/seller_info.dart';
import 'package:bed3avendor/data/model/response/withdraw_model.dart';
