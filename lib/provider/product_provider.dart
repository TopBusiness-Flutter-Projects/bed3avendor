...
import 'package:bed3avendor/data/model/response/product_review_model.dart';
import 'package:bed3avendor/data/model/response/review_model.dart' as rm;
import 'package:bed3avendor/data/model/response/top_selling_product_model.dart';
import 'package:bed3avendor/data/repository/product_repo.dart';
...
class ProductProvider extends ChangeNotifier {
  ...
  Future<void> getPosProductList(int offset, BuildContext context,
      {bool reload = true}) async {
    _isLoading = true;
  ...
  Future<void> getStockOutProductList(
  ...
  Future<void> barCodeDownload(
    ...
    if (apiResponse.response!.statusCode == 200) {
      ...
      showCustomSnackBar(
          getTranslated('barcode_downloaded_successfully', context), context,
          isError: false);
