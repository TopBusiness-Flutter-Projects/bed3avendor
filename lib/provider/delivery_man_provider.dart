...
import 'package:bed3avendor/data/model/body/delivery_man_body.dart';
import 'package:bed3avendor/data/model/response/base/api_response.dart';
import 'package:bed3avendor/data/model/response/collected_cash_model.dart';
import 'package:bed3avendor/data/model/response/delivery_man_detail_model.dart'
    as d;
import 'package:bed3avendor/data/model/response/delivery_man_earning_model.dart';
import 'package:bed3avendor/data/model/response/delivery_man_model.dart';
import 'package:bed3avendor/data/model/response/delivery_man_order_history_model.dart';
import 'package:bed3avendor/data/model/response/delivery_man_review_model.dart';
import 'package:bed3avendor/data/model/response/delivery_man_withdraw_detail_model.dart';
import 'package:bed3avendor/data/model/response/delivery_man_withdraw_model.dart';
import 'package:bed3avendor/data/model/response/order_history_log_model.dart';
...
class DeliveryManProvider extends ChangeNotifier {
  ...
  Future<void> getDeliveryManList(
      Order? orderModel, BuildContext context) async {
    _deliveryManIds = [];
  ...
  Future<void> deliveryManListURI(
      BuildContext context, int offset, String search,
  ...
  Future<void> getDeliveryManDetails(
  ...
  Future<void> assignDeliveryMan(
    ...
    if (apiResponse.response != null &&
      ...
      _isLoading = false;
      showCustomSnackBar(
          getTranslated('delivery_man_assign_successfully', context), context,
  ...
  Future<void> deliveryManStatusOnOff(
    ...
    if (apiResponse.response != null &&
      ...
      _isLoading = false;
      showCustomSnackBar(
          getTranslated('status_updated_successfully', context), context,
          isToaster: true, isError: false);
    } else {
      _isLoading = false;
      ApiChecker.checkApi(context, apiResponse);
  ...
  Future<void> collectCashFromDeliveryMan(
    ...
    if (apiResponse.response != null &&
      ...
      showCustomSnackBar(
          getTranslated('amount_collected_from_deliveryman', context), context,
          isToaster: true);
    } else {
      _isLoading = false;
  ...
  Future<ApiResponse> addNewDeliveryMan(
    ...
    if (response.response!.statusCode == 200) {
      ...
      isUpdate
          ? showCustomSnackBar(
              getTranslated("delivery_man_updated_successfully", context),
              context,
              isError: false)
          : showCustomSnackBar(
              getTranslated("delivery_man_added_successfully", context),
              context,
              isError: false);
    } else {
      _isLoading = false;
  ...
  Future<void> getDeliveryManWithdrawList(
      BuildContext context, int offset, String status,
      {bool reload = true}) async {
    ApiResponse apiResponse =
