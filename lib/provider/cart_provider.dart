...
import 'package:bed3avendor/data/model/body/customer_body.dart';
...
import 'package:bed3avendor/data/model/response/customer_model.dart';
import 'package:bed3avendor/data/model/response/product_model.dart';
import 'package:bed3avendor/data/model/response/temporary_cart_for_customer.dart';
...
import 'package:bed3avendor/view/screens/order/invoice_screen.dart';
import 'package:bed3avendor/view/screens/pos/widget/product_variation_selection_dialog.dart';
...
class CartProvider extends ChangeNotifier {
  ...
  void applyCouponCodeAndExtraDiscount(BuildContext context) {
    ...
    if (_extraDiscountAmount > _amount) {
      ...
      showCustomSnackBar(
          getTranslated('extra_discount_added_successfully', context) ?? '',
          context,
          isToaster: true,
          isError: false);
    }
  ...
  Future<void> getCouponDiscount(BuildContext context, String couponCode,
    ...
    if (response.response!.statusCode == 200) {
      ...
      showCustomSnackBar(
          'You got ${_couponCodeAmount.toString()} discount', context,
          isToaster: true, isError: false);
  ...
  Future<ApiResponse> placeOrder(
    ...
    if (response.response!.statusCode == 200) {
      ...
      showCustomSnackBar(
          getTranslated('order_placed_successfully', context) ?? '', context,
          isToaster: true, isError: false);
      _extraDiscountAmount = 0;
      _amount = 0;
      _collectedCashController.clear();
  ...
  Future<void> getProductFromScan(
    ...
    if (response.response!.statusCode == 200) {
      ...
      Provider.of<ProductProvider>(context, listen: false)
          .initData(_scanProduct!, 1, context);
