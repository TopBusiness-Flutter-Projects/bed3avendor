...
class DeliveryManRepo {
  ...
  Future<ApiResponse> deliveryManWithdrawList(int offset, String status) async {
    try {
      final response = await dioClient!.get(
          '${AppConstants.DELIVERY_MAN_WITHDRAW_LIST}?limit=10&offset=$offset&status=$status');
      return ApiResponse.withSuccess(response);
    } catch (e) {
      return ApiResponse.withError(ApiErrorHandler.getMessage(e));
    }
  ...
  Future<ApiResponse> getDeliveryManReviewList(int offset, int? id) async {
    try {
      final response = await dioClient!.get(
          '${AppConstants.DELIVERY_MAN_REVIEW_LIST}$id?limit=10&offset=$offset');
      return ApiResponse.withSuccess(response);
    } catch (e) {
      return ApiResponse.withError(ApiErrorHandler.getMessage(e));
    }
  ...
  Future<ApiResponse> deliveryManWithdrawDetails(int? id) async {
    try {
      final response = await dioClient!
          .get('${AppConstants.DELIVERY_MAN_WITHDRAW_DETAILS}$id');
      return ApiResponse.withSuccess(response);
    } catch (e) {
      return ApiResponse.withError(ApiErrorHandler.getMessage(e));
    }
  ...
  Future<ApiResponse> deliveryManWithdrawApprovedDenied(
    ...
    try {
      final response = await dioClient!.post(
          '${AppConstants.DELIVERY_MAN_WITHDRAW_APPROVED_REJECTED}',
          data: {
            '_method': "put",
            'id': id,
            'note': note,
  ...
  Future<ApiResponse> deliveryManList(int offset, String search) async {
    try {
      final response = await dioClient!.get(
          '${AppConstants.DELIVERY_MAN_LIST_URI}?limit=10&offset=$offset&search=$search');
      return ApiResponse.withSuccess(response);
    } catch (e) {
      return ApiResponse.withError(ApiErrorHandler.getMessage(e));
    }
  ...
  Future<ApiResponse> deliveryManDetails(int? deliveryManId) async {
    try {
      final response = await dioClient!
          .get('${AppConstants.DELIVERY_MAN_DETAILS}$deliveryManId');
      return ApiResponse.withSuccess(response);
    } catch (e) {
      return ApiResponse.withError(ApiErrorHandler.getMessage(e));
    }
  ...
  Future<ApiResponse> deliveryManOrderList(
    ...
    try {
      final response = await dioClient!.get(
          '${AppConstants.DELIVERY_MAN_ORDER_HISTORY}$deliverymanId?limit=10&offset=$offset');
      return ApiResponse.withSuccess(response);
    } catch (e) {
      return ApiResponse.withError(ApiErrorHandler.getMessage(e));
    }
  ...
  Future<ApiResponse> deliveryManEarningList(
    ...
    try {
      final response = await dioClient!.get(
          '${AppConstants.DELIVERY_MAN_EARNING}$deliverymanId?limit=10&offset=$offset');
      return ApiResponse.withSuccess(response);
    } catch (e) {
      return ApiResponse.withError(ApiErrorHandler.getMessage(e));
    }
  ...
  Future<ApiResponse> deliveryManStatusOnOff(int? id, int status) async {
    ...
    try {
      final response = await dioClient!.post(
          AppConstants.DELIVERYMAN_STATUS_ON_OFF,
  ...
  Future<ApiResponse> collectCashFromDeliveryMan(
    ...
    try {
      ...
      final response = await dioClient!.post(
          AppConstants.COLLECT_CASH_FROM_DELIVERY_MAN,
  ...
  Future<ApiResponse> deleteDeliveryMan(int? deliveryManId) async {
    try {
      final response = await dioClient!
          .get('${AppConstants.DELETE_DELIVERY_MAN}$deliveryManId');
      return ApiResponse.withSuccess(response);
    } catch (e) {
      return ApiResponse.withError(ApiErrorHandler.getMessage(e));
    }
  ...
  Future<ApiResponse> getDeliverymanOrderHistoryLog(int? orderId) async {
    try {
      final response = await dioClient!
          .get('${AppConstants.DELIVERY_MAN_ORDER_CHANGE_LOG}$orderId');
      return ApiResponse.withSuccess(response);
    } catch (e) {
      return ApiResponse.withError(ApiErrorHandler.getMessage(e));
    }
  ...
  Future<ApiResponse> addNewDeliveryMan(XFile? profileImage,
    ...
    if (profileImage != null) {
      ...
      var part = http.MultipartFile(
          'image', profileImage.readAsBytes().asStream(), _list.length,
    ...
    if (identityImage.isNotEmpty) {
      for (int i = 0; i < identityImage.length; i++) {
        ...
        var part = http.MultipartFile('identity_image',
            identityImage[i]!.readAsBytes().asStream(), _list.length,
  ...
  Future<ApiResponse> getDeliveryManCollectedCashList(
    ...
    try {
      final response = await dioClient!.get(
          '${AppConstants.DELIVERY_MAN_COLLECTED_CASH_LIST}$id?limit=10&offset=$offset');
      return ApiResponse.withSuccess(response);
    } catch (e) {
      return ApiResponse.withError(ApiErrorHandler.getMessage(e));
    }
