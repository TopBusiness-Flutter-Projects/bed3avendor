      ...
      if (type == 'meta') {
        ...
        if (Provider.of<SellerProvider>(context, listen: false)
          ...
          for (int index = 0;
            ...
            print(
                '===check color=>${Provider.of<SellerProvider>(context, listen: false).withColor[index].color}/$colorCode');
            if (bb == colorCode) {
              Provider.of<SellerProvider>(context, listen: false)
                      ...
                      ? Column(
                          ...
                          children: [
                            ...
                            TextFieldTags(
                              textfieldTagsController: _controller,
                              initialTags:
                                  _update ? tagList as List<String>? : const [],
                            ...
                            /*    Row(
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: Text(
                                      getTranslated('product_seo_settings',
                                              context) ??
                                          '',
                                    ...
                                    child: resProvider.pickedMeta != null
                                        ...
                                        : widget.product != null
                                            ? FadeInImage.assetNetwork(
                                                ...
                                                image:
                                                    '${Provider.of<SplashProvider>(context).configModel!.baseUrls!.productImageUrl}/meta/${_product!.metaImage != null ? _product!.metaImage : ''}',
                                                height: 120,
                                                width: 150,
                                                fit: BoxFit.cover,
                                        ...
                                        : widget.product != null
                                            ? FadeInImage.assetNetwork(
                                                placeholder:
                                                    Images.placeholder_image,
                                                image:
                                                    '${Provider.of<SplashProvider>(context).configModel!.baseUrls!.productThumbnailUrl}/${_product!.thumbnail != null ? _product!.thumbnail : ''}',
                                                height: 120,
                                                width: 150,
                                                fit: BoxFit.cover,
                                                imageErrorBuilder: (c, o, s) =>
                            ...
                            if (resProvider.attributeList![0].active &&
                                resProvider.attributeList![0].variants.length >
                                    0)
                              GridView.builder(
                                  gridDelegate:
                                  ...
                                  itemBuilder: (context, index) {
                                    ...
                                    if (resProvider.withColor[index].color !=
                                        null) {
                                      colorString = '0xff' +
                                          resProvider.withColor[index].color!
                                              .substring(1, 7);
                                    }
          ...
          child: !resProvider.isLoading
              ? CustomButton(
                  ...
                  onTap: () {
                    ...
                    resProvider.descriptionControllerList
                        .forEach((description) {
                    ...
                    if (!_update && resProvider.pickedLogo == null) {
                      ...
                      _product!.purchasePrice =
                          PriceConverter.systemCurrencyToDefaultCurrency(
                              double.parse(widget.purchasePrice ?? ''),
                              context);
                      ...
                      if (resProvider.colorCodeList.isNotEmpty) {
                        _addProduct!.colorCodeList!
                      ...
                      if (_update) {
                        if (resProvider.pickedLogo == null &&
                                ...
                                resProvider.productImage.length == 0 ||
                            resProvider.productImage.isNotEmpty) {
                          Provider.of<SellerProvider>(context, listen: false)
                              .addProduct(
                            context,
                            _product!,
