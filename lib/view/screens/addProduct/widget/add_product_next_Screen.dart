...
import 'package:bed3avendor/view/base/attribute_view.dart';
...
*/
                          ...
                          Row(
                            ...
                            children: [
                              Text(
                                  getTranslated(
                                          'product_price_and_stock', context) ??
                                      '',
                                  style: robotoBold.copyWith(
                          ...
                          Row(
                            children: [
                              ...
                              Expanded(
                                ...
                                children: [
                                  Text(
                                      getTranslated('minimum_order_quantity',
                                              context) ??
                                          '',
                                      style: robotoRegular.copyWith(
                                          fontSize:
              ...
              return CustomButton(
                ...
                onTap: () {
                  ...
                  if (_unitPrice.isEmpty) {
                    ...
                    showCustomSnackBar(
                        getTranslated(
                                'enter_minimum_order_quantity', context) ??
                            '',
                        context);
                    ...
                    showCustomSnackBar(
                        getTranslated(
                                'enter_price_for_every_variant', context) ??
                            '',
                        context);
