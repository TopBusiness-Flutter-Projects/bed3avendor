...
import 'package:bed3avendor/view/screens/addProduct/widget/add_product_next_Screen.dart';
import 'package:bed3avendor/view/screens/addProduct/widget/digital_product_widget.dart';
import 'package:bed3avendor/view/screens/addProduct/widget/select_category_widget.dart';
...
class AddProductScreen extends StatefulWidget {
  ...
  AddProductScreen({Key? key, this.product, this.addProduct, this.editProduct})
      : super(key: key);
  @override
                                ...
                                child: Column(
                                  children: [
                                    Row(
                                      children: [
                                        Text(
                                            getTranslated('product_code_sku',
                                                    context) ??
                                                '',
                                        ...
                                        children: [
                                          ...
                                          Container(
                                            ...
                                            child: DropdownButton<int>(
                                              ...
                                              items:
                                                  _brandIds.map((int? value) {
                                                return DropdownMenuItem<int>(
                                                  value:
                                                      _brandIds.indexOf(value),
                                                  child: Text(value != 0
                                                      ? resProvider
                                                          .brandList![(_brandIds
                                                                  .indexOf(
