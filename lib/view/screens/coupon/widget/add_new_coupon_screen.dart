...
import 'package:bed3avendor/data/model/response/coupon_model.dart';
...
import 'package:bed3avendor/view/base/custom_date_picker.dart';
import 'package:bed3avendor/view/base/custom_drop_down_item.dart';
import 'package:bed3avendor/view/base/custom_field_with_title.dart';
          ...
          child: Consumer<CouponProvider>(builder: (context, coupon, _) {
            return Consumer<CartProvider>(builder: (context, customer, _) {
              return Padding(
                ...
                child: coupon.isAdd
                    ? Container(width: 40, child: CircularProgressIndicator())
                    : CustomButton(
                        ...
                        onTap: () {
                          ...
                          String? startDate = update
                              ? widget.coupons!.startDate
                              : coupon.dateFormat
                                  .format(coupon.startDate!)
                                  .toString();
                          String? endDate = update
                              ? widget.coupons!.expireDate
                              : coupon.dateFormat
