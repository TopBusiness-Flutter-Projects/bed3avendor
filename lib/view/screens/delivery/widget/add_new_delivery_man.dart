...
import 'package:bed3avendor/helper/email_checker.dart';
                      ...
                      onTap: () {
                        ...
                        // } 
                          ...
                          showCustomSnackBar(
                              ...
                              context);
                        } else if (deliveryManProvider.addressController.text
                            .trim()
                            .isEmpty) {
                          showCustomSnackBar(
                                  ...
                                  onTap: () {
                                    if (deliveryManProvider.firstNameController.text
                                      ...
                                      showCustomSnackBar(
                                        ...
                                        deliveryManProvider.emailController.text
                                            .trim())) {
                                      showCustomSnackBar(
                                          getTranslated(
                                      ...
                                      showCustomSnackBar(
                                          getTranslated(
                                              ...
                                              context),
                                          context);
                                    } else if (deliveryManProvider.passwordController.text.trim().isEmpty &&
                                        widget.deliveryMan == null) {
                                      showCustomSnackBar(
                                          getTranslated(
                                      ...
                                      showCustomSnackBar(
                                        ...
                                        deliveryManProvider.confirmPasswordController.text
                                            .trim()) {
                                      showCustomSnackBar(
                                          getTranslated(
