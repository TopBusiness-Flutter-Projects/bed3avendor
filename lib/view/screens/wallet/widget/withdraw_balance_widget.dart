...
import 'package:bed3avendor/view/base/custom_edit_dialog.dart';
...
class _WithdrawBalanceWidgetState extends State<WithdrawBalanceWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        Container(
          padding: EdgeInsets.fromLTRB(0, Dimensions.PADDING_SIZE_DEFAULT, 0,
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              Text(
                                  getTranslated('balance_withdraw', context) ??
                                      '',
