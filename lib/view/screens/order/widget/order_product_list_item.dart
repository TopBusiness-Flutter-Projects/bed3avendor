...
class _OrderedProductListItemState extends State<OrderedProductListItem> {
  ...
  void initState() {
    ...
    // FlutterDownloader.registerCallback(downloadCallback as void Function(String, int, int));
  }
                        ...
                        Row(
                          children: [
                            (widget.orderDetailsModel!.productDetails!
                                ...
                                : SizedBox(),
                            SizedBox(
                                width: widget.orderDetailsModel!.productDetails!
                                            .discount! >
                                        0
                                ...
                                child: Center(
                                  ...
                                  children: [
                                    ...
                                    Container(
                                        ...
                                        child: Image.asset(Images.download_file,
                                            color: Colors.white))
                                  ],
                                )),
                              ),
