...
import 'package:bed3avendor/view/screens/pos_printer/invoice_print.dart';
...
class _InVoiceScreenState extends State<InVoiceScreen> {
  Future<void> _loadData() async {
    await Provider.of<OrderProvider>(context, listen: false)
        .getInvoiceData(context, widget.orderId);
                                                  ...
                                                  children: [
                                                    ...
                                                    SizedBox(
                                                        width: Dimensions
                                                            .PADDING_SIZE_DEFAULT),
                                                    Text(
                                                        '${PriceConverter.convertPrice(context, orderController.invoice!.details![index].price)}'),
                                                  ],
                                                ),
                                              ),
                                            ],
