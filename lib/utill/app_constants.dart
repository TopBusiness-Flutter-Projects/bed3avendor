import 'package:bed3avendor/data/model/response/language_model.dart';
...
class AppConstants {
  ...
  static const String PRODUCT_REVIEW_URI =
      '/api/v3/seller/shop-product-reviews';
  static const String PRODUCT_REVIEW_STATUS_ON_OFF =
  ...
  static const String GET_DELIVERY_MAN_URI =
      '/api/v3/seller/seller-delivery-man';
  ...
  static const String FORGET_PASSWORD_URI =
      '/api/v3/seller/auth/forgot-password';
  ...
  static const String BAR_CODE_GENERATE =
      '/api/v3/seller/products/barcode/generate';
  static const String DIGITAL_PRODUCT_UPLOAD =
      '/api/v3/seller/products/upload-digital-product';
  static const String DIGITAL_PRODUCT_UPLOAD_AFTER_SELL =
  ...
  static const String TOP_SELLING_PRODUCT =
      '/api/v3/seller/products/top-selling-product?limit=10&offset=';
  static const String MOST_POPULAR_PRODUCT =
  ...
  static const String DELIVERY_MAN_LIST_URI =
      '/api/v3/seller/delivery-man/list';
  static const String DELIVERY_MAN_DETAILS =
      '/api/v3/seller/delivery-man/details/';
  static const String POS_PRODUCT_LIST = '/api/v3/seller/pos/product-list';
  static const String SEARCH_POS_PRODUCT_LIST =
      '/api/v3/seller/pos/product-list';
  static const String SHIPPING_METHOD_ON_OFF =
      '/api/v3/seller/shipping-method/status';
  static const String UPDATE_PRODUCT_QUANTITY =
      '/api/v3/seller/products/quantity-update';
  static const String PRODUCT_WISE_REVIEW_LIST =
      '/api/v3/seller/products/review-list/';
  static const String ADD_DELIVERY_MAN = '/api/v3/seller/delivery-man/store';
  static const String UPDATE_DELIVERY_MAN =
      '/api/v3/seller/delivery-man/update';
  static const String DELETE_DELIVERY_MAN =
      '/api/v3/seller/delivery-man/delete/';
  static const String DELIVERY_MAN_ORDER_HISTORY =
      '/api/v3/seller/delivery-man/order-list/';
  static const String DELIVERY_MAN_EARNING =
      '/api/v3/seller/delivery-man/earning/';
  static const String COLLECT_CASH_FROM_DELIVERY_MAN =
      '/api/v3/seller/delivery-man/cash-receive';
  static const String EMERGENCY_CONTACT_ADD =
      '/api/v3/seller/delivery-man/emergency-contact/store';
  static const String EMERGENCY_CONTACT_UPDATE =
      '/api/v3/seller/delivery-man/emergency-contact/update';
  static const String GET_EMERGENCY_CONTACT_LIST =
      '/api/v3/seller/delivery-man/emergency-contact/list';
  static const String EMERGENCY_CONTACT_STATUS_ON_OFF =
      '/api/v3/seller/delivery-man/emergency-contact/status-update';
  static const String EMERGENCY_CONTACT_DELETE =
      '/api/v3/seller/delivery-man/emergency-contact/delete';
  static const String DELIVERY_MAN_WITHDRAW_LIST =
      '/api/v3/seller/delivery-man/withdraw/list';
  static const String DELIVERY_MAN_REVIEW_LIST =
      '/api/v3/seller/delivery-man/reviews/';
  static const String DELIVERY_MAN_WITHDRAW_DETAILS =
      '/api/v3/seller/delivery-man/withdraw/details/';
  static const String DELIVERY_MAN_WITHDRAW_APPROVED_REJECTED =
      '/api/v3/seller/delivery-man/withdraw/status-update';
  static const String ADD_NEW_CUSTOMER = '/api/v3/seller/pos/customer-store';
  static const String PRODUCT_STATUS_ON_OFF =
      '/api/v3/seller/products/status-update';
  static const String DELIVERYMAN_STATUS_ON_OFF =
      '/api/v3/seller/delivery-man/status-update';
  static const String EARNING_STATISTICS =
  ...
  static const String CHART_FILTER_DATA =
      '/api/v3/seller/get-earning-statitics?type=';
  ...
  static const String COUPON_STATUS_UPDATE =
      '/api/v3/seller/coupon/status-update/';
  static const String DELIVERY_MAN_COLLECTED_CASH_LIST =
      '/api/v3/seller/delivery-man/collect-cash-list/';
  static const String COUPON_CUSTOMER_LIST =
